...
class MoFlowModule(LightningModule):
    ...
    def __init__(
        ...
        self.val_count = SumMetric()
        self.test_count = SumMetric()
    ...
    def training_step(
        ...
        self.log("train/loss_step", self.train_loss, on_step=False, on_epoch=True, prog_bar=True)
        return loss
    ...
    def reconstruction_similarity(self, x, adj, x_rev, adj_rev):
        reverse_smiles = adj_to_smiles(adj_rev.cpu(), x_rev.cpu(), list(self.net.atomic_list))
        train_smiles = adj_to_smiles(adj.cpu(), x.cpu(), list(self.net.atomic_list))
    ...
    def test_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        if batch_idx == 0:
            ...
            self.log("test/similarity", self.test_acc, on_step=False, on_epoch=True, prog_bar=True)
            self.log("test/nan_count", self.test_count, on_step=False, on_epoch=True, prog_bar=True)
...
if __name__ == "__main__":
    _ = MoFlowModule(None, None, None, None)
